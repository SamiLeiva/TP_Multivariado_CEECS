...
Para visualizar más sencillamente las cargas de cada variable sobre las tres componentes, se guarda los resultados de los *loadings* en un dataframe para mostrar los resultados de esas componentes. 
```{r}
cargas <-  loadings(cp)
